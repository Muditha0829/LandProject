    ...
    return (
        <div>
            ...
            <Box sx={{ py: 2 }} style={{ backgroundColor: 'lightblue' }}>        
                <center><label style={{ fontSize: "40px" }}>Property Ad Store</label></center>
            </Box>
                            ...
                            <Card sx={{ width: "100%", bgcolor: "#cad5e8", height: "auto", m:2, p: 2 }} >
                                ...
                                <Stack direction="colomn" justifyContent="space-between" >  
                                    ...
                                    <Grid  xs={6}>
                                        ...
                                        <Link to={`/specific-ad/${wtd._id}`}><Button variant="contained" sx={{ mb: 2}}>Show More</Button></Link>
                                ...
                                {/* <Stack sx={{ mt: 3 }} >
                                    ...
                                    <Box display="flex" justifyContent="flex-end" >
                                        <Grid sx={{ mx: 1 }}>
                                            <Link to={`/edit-header/${wtd._id}`}><Button variant="contained" sx={{ mb: 2}}>Edit</Button></Link>
                                        </Grid>
